...
| Key Exchange Algorithm | Status           | FIPS-compliant | Notes                                         |
| ---------------------- | ---------------- | -------------- | --------------------------------------------- |
| X25519MLKEM768         | Supported        | ❌             | Hybrid approach combining X25519 and MLKEM768 |
| X25519                 | Standard support | ✅             | Widely used elliptic curve key exchange       |
